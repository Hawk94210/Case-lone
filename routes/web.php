...
Route::prefix('home')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::post('/',[InoteController::class,'store'])->name('store');

        Route::get('{id}/get',[InoteController::class,'getNoteById'])->name('get.id');

        Route::get('{id}/edit',[InoteController::class,'edit'])->name('show.edit');

        Route::post('{id}/edit',[InoteController::class,'update'])->name('edit');

        Route::delete('delete/{id}',[InoteController::class,'destroy']);
